...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        true_img = PhotoImage(file="images/true.png") #not self. as it will not be interacted anywhere
        self.true_button = Button(image=true_img, highlightthickness=0, command=self.true_press)
        self.true_button.grid(row=2, column=0)

        false_img = PhotoImage(file="images/false.png") #not self. as it will not be interacted anywhere
